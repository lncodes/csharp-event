...
Thank you for your interest in contributing to **csharp-event** by Last Night Codes! Your support is crucial to this project growth. To ensure everything goes smoothly, please follow these guidelines.
...
1. Before reporting a new issue, look through the project’s [issue tracker](https://github.com/lncodes/csharp-event/issues) to check if the issues has already been reported.
...
1. Find the relevant issue in the project [issue tracker](https://github.com/lncodes/csharp-event/issues).
